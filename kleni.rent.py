...
def main():
    ...
    απαραίτητο_εισόδημα_γιορτές = ετήσιο_εισόδημα_για_ROI0 * αναλογία_εισοδήματος_γιορτές
    απαραίτητο_εισόδημα_καλοκαίρι = ετήσιο_εισόδημα_για_ROI0 * αναλογία_εισοδήματος_καλοκαίρι
    απαραίτητο_εισόδημα_κανονικές = ετήσιο_εισόδημα_για_ROI0 * αναλογία_εισοδήματος_κανονικές
