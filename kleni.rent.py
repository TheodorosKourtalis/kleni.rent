...
def main():
    ...
    # Υπολογισμός αναλογίας εισοδήματος (γιορτές, καλοκαίρι, κανονικές)
    if συνολικό_εισόδημα_ανά_έτος > 0:
        ...
        αναλογία_εισοδήματος_γιορτές = 0
        αναλογία_εισοδήματος_καλοκαίρι = 0
        αναλογία_εισοδήματος_κανονικές = 0
    ...
    st.write("""
        Παρακάτω μπορείς να δεις ποιο είναι το ελάχιστο δυνατό ενοίκιο που πρέπει να χρεώνεις 
        για κάθε περίοδο, ώστε η Απόδοση (ROI) να είναι 0 
    ...
    with col3:
        ...
        if συνολικές_γιορτές_μέρες > 0:
            st.write(f"**Απαιτούμενο Εισόδημα:** €{απαραίτητο_εισόδημα_γιορτές:.2f}")
            st.write(f"**Απαραίτητη Τιμή Ενοικίου:** €{απαραίτητη_τιμή_γιορτές:.2f}/μέρα")
        else:
    ...
    with col4:
        ...
        if συνολικές_καλοκαιρινές_μέρες > 0:
            st.write(f"**Απαιτούμενο Εισόδημα:** €{απαραίτητο_εισόδημα_καλοκαίρι:.2f}")
            st.write(f"**Απαραίτητη Τιμή Ενοικίου:** €{απαραίτητη_τιμή_καλοκαίρι:.2f}/μέρα")
        else:
    ...
    with col5:
        ...
        if συνολικές_κανονικές_μέρες > 0:
            st.write(f"**Απαιτούμενο Εισόδημα:** €{απαραίτητο_εισόδημα_κανονικές:.2f}")
