...
def main():
    ...
    εισόδημα_καλοκαίρι = συνολικές_καλοκαιρινές_μέρες = καλοκαίρι_μέρες * τιμή_καλοκαίρι
    εισόδημα_κανονικές = συνολικές_κανονικές_μέρες = max(365 - συνολικές_γιορτές_μέρες - συνολικές_καλοκαιρινές_μέρες, 0) * τιμή_κανονικές
