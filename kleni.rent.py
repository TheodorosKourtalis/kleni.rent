...
def main():
    ...
    # Υπολογισμός αναλογίας εισοδήματος
    if συνολικό_εισόδημα_ανά_έτος > 0:
    ...
    # Υπολογισμός απαραίτητου εισόδηματος ανά περίοδο για ROI=0
    ...
    # Εμφάνιση Απαιτούμενων Τιμών Ενοικίασης
    ...
    with col3:
        ...
        if συνολικές_γιορτές_μέρες > 0:
            ...
            st.write(f"**Απαιτούμενη Τιμή Ενοικίου:** €{απαραίτητη_τιμή_γιορτές:.2f}/μέρα")
        else:
    ...
    with col4:
        ...
        if συνολικές_καλοκαιρινές_μέρες > 0:
            ...
            st.write(f"**Απαιτούμενη Τιμή Ενοικίου:** €{απαραίτητη_τιμή_καλοκαίρι:.2f}/μέρα")
        else:
    ...
    with col5:
        ...
        if συνολικές_κανονικές_μέρες > 0:
            ...
            st.write(f"**Απαιτούμενη Τιμή Ενοικίου:** €{απαραίτητη_τιμή_κανονικές:.2f}/μέρα")
        else:
